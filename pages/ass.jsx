...
//   fetch("api/isteacher", { // note we are going to /1
//   method: "PATCH",
//   headers: {
...
//   body: JSON.stringify(
//     {
//       scored : { score }        // we are changing the "likes" value to 5
//     }
//   )
// });
// },[])
...
//         {displayscore ? <div className="w-screen h-full absolute top-0 left-0 z-10 bg-blue-500"><div className="flex flex-col items-center justify-center h-full">
//         <div className=" text-7xl">{score}/5</div>
//         <Link className="text-7xl bg-lime-500 p-5
//          m-2 rounded-lg cursor-pointer
//          " href="./topicburn/hero22">Home</Link>
//         </div></div> : <div></div>}
